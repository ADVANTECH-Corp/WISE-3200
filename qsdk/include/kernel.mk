...
## [Advantech] Add localversion for kernel modules
  LINUX_LOCALVERSION:=$(strip $(shell cat $(LINUX_DIR)/localversion 2>/dev/null))
  ifneq ($(LINUX_LOCALVERSION),)
    LINUX_UNAME_VERSION:=$(LINUX_UNAME_VERSION)$(LINUX_LOCALVERSION)
  endif
##
